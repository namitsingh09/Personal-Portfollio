...
export default function Worke() {
  ...
  <div id='anim' style={{borderTop: '0.9px solid white', borderBottom: '1.9px solid white', padding:70, marginTop:50, fontFamily:'teko'}}>
    ...
    <div className='item2'>
<p  style={{fontSize:'20px', padding:'10px', width:'100%', textAlign:'center', marginTop:'30px' , borderBottom:'0.9px solid white', height:'200px'}}>A collection of weird websites, niche data projects, and CSS experiments.  and lately I’ve been working on Personal Projects and Builiding in Public which are both pretty fun.</p>
</div>
...
<div class="grid grid-cols-1 gap-3 sm:grid-cols-3 md:gap-3 xl:gap-3" style={{padding:'10px', margin:'20px'}}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            ...
            <a href="#"
                ...
                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpaperaccess.com%2Ffull%2F2772922.png&f=1&nofb=1&ipt=a8b08766b18a7746ab3d09aab44197f05eaf019dfaea5e0a00dcfec1206b534a&ipo=images" loading="lazy" alt="Photo by Magicle" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            ...
            <a href="#"
                ...
                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpaperaccess.com%2Ffull%2F2772922.png&f=1&nofb=1&ipt=a8b08766b18a7746ab3d09aab44197f05eaf019dfaea5e0a00dcfec1206b534a&ipo=images" loading="lazy" alt="Photo by Martin Sanchez" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />

                <div
                    class="pointer-events-none absolute inset-0 bg-gradient-to-t from-gray-500 via-transparent to-transparent opacity-50">
                </div>

                <span class="relative ml-2 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Lorem ipsum</span>
                <button class="absolute inset-0 flex items-center justify-center text-white opacity-0 group-hover:opacity-100" onclick="navigateToLink('/About')">
   ...
   <div class="text-center">
    ...
    <span class="block text-sm text-center text-gray-500">
        ...
        <a href="https://flowbite.com"
            ...
            <a
			href="https://tailwindcss.com" class="text-purple-600 hover:underline"> Namit
			Singh
        </a>.
	</span>
